...
Route::get('annonces/c/{city}','MultiplesRouteController@annoncesbycityslug')->name('annonces_view_city_slug');
Route::get('annonces/v/{city}','MultiplesRouteController@annoncesbycity')->name('annonces_view_city_by_city');
...
Route::get('annonces/{occupation}/{categoryoccupation}/{city}','MultiplesRouteController@annoncesbycity')->name('annonces_view_cities');
...
Route::get('charbonneurs/{occupation}/{city}','MultiplesRouteController@charbonneursbyoccupation')->name('charbonneurs_by_occupation_city');
