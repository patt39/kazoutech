...
Route::group(['namespace' => 'Partial'], function(){
    ...
    require(__DIR__ . DIRECTORY_SEPARATOR . 'activities.php');
    require(__DIR__ . DIRECTORY_SEPARATOR . 'category_faqs.php');
    require(__DIR__ . DIRECTORY_SEPARATOR . 'change_password.php');
    require(__DIR__ . DIRECTORY_SEPARATOR . 'cities.php');
    require(__DIR__ . DIRECTORY_SEPARATOR . 'followers.php');
