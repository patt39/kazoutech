                                        ...
                                        <div class="card">
                                            <div :class="getColorCardUser()" style="margin-top: -5px;">
                                                ...
                                                <h4 class="card-title" style="margin-top: 0px;"><b>Create</b> -
                                                    <small class="category">New Technician</small>
                                                </h4>
                                            </div>
                                            <br>
                                            <div class="card-body">
    ...
    export default {
        ...
        methods: {
            ...
            createItem() {
                ...
                this.form.post("/dashboard/technicians")
                    .then(() => {
                        ...
                        setTimeout(function() {
                            notify.update({'type': 'success', 'message': '<strong>Technician Created Successfully.</strong>', 'progress': 75});
                        }, 2000);
