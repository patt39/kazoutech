                        ...
                        <div class="col-md-12 expo">
                            <div class="card card-stats">
                                <div :class="getColorCardUser()">
                                    ...
                                    <p class="card-category"><b>All Languages</b>
                                    <h3 class="card-title" style="color:red;"><b>{{languages.length}}</b></h3>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons">g_translate</i><b>All Languages</b>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div :class="getColorHeaderUser()">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h4 class="card-title">
                                                <b>Datatables Languages</b>
                                            </h4>
                                            <p class="card-title">
                                                Languages Choice For Buttons
                                            </p>
                                        </div>
                                        <div class="col-md-6 text-right">
                                <span>
                                    <i id="tooltipSize" class="material-icons">g_translate</i>
                                </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div v-if="$auth.can('create-color')" class="toolbar">
                                     ...
                                     <span class="btn-label">
                                        <i class="material-icons">g_translate</i>
                                                ...
                                                <b class="title_hover">New Language</b>
                                            </button>
                                        </div>
                                    </div>
            ...
            storeItem() {
                ...
                this.form.post("/dashboard/colors")
                    .then(() => {
                        ...
                        setTimeout(function() {
                            notify.update({'type': 'success', 'message': '<strong>Language Created Successfully.</strong>', 'progress': 75});
                        }, 2000);
            ...
            updateItem() {
                ...
                this.form.put('/dashboard/colors/' + this.form.id)
                    .then(() => {
                        ...
                        setTimeout(function() {
                            notify.update({'type': 'success', 'message': '<strong>Language updated successfully.</strong>', 'progress': 75});
                        }, 2000);
                        /** Fin alert **/
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        axios.delete('/dashboard/colors/' + id).then(() => {
                            ...
                            setTimeout(function() {
                                notify.update({'type': 'success', 'message': '<strong>Language deleted successfully.</strong>', 'progress': 75});
                            }, 2000);
                            /* End alert ***/
