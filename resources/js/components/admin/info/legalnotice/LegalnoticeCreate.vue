                                        ...
                                        <div class="card">
                                            <div :class="getColorCardUser()" style="margin-top: -5px;">
                                                ...
                                                <h4 class="card-title" style="margin-top: 0px;"><b>Create</b> -
                                                    <small class="category">New Legal Notice</small>
                                                </h4>
                                            </div>
                                            <br>
                                            <div class="card-body">
                                                <form id="RegisterValidation" @submit.prevent="createItem()" role="form"
                                                    ...
                                                    <div class="submit">
                                                        <div class="text-center">
                                                            <router-link :to="{ name: 'legal_notice.index' }" class="btn btn-danger btn-round" id="button_hover">
    ...
    export default {
        ...
        methods: {
            ...
            createItem() {
                ...
                this.form.post("/dashboard/legal_notice")
                    .then(() => {
                        ...
                        setTimeout(function() {
                            notify.update({'type': 'success', 'message': '<strong>Legal Notice Created Successfully.</strong>', 'progress': 75});
                        }, 2000);
