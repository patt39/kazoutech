                        ...
                        <div class="col-md-12 expo">
                            <div class="card card-stats">
                                ...
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons">indeterminate_check_box</i><b>All Terms & Conditions</b>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        methods: {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        this.form.delete('/dashboard/conditions/' + id).then(() => {
                            ...
                            setTimeout(function() {
                                notify.update({'type': 'success', 'message': '<strong>Term & Condition deleted successfully.</strong>', 'progress': 75});
                            }, 2000);
                            /* End alert ***/
            ...
            activeItem(id) {
                ...
                this.form.get('/dashboard/active_condition/' + id).then(() => {
                    ...
                    setTimeout(function() {
                        notify.update({'type': 'success', 'message': '<strong>Term & Condition activated successfully.</strong>', 'progress': 75});
                    }, 2000);
                    /** End alert **/
            ...
            disableItem(id) {
                ...
                this.form.get('/dashboard/unactive_condition/' + id).then(() => {
                    ...
                    setTimeout(function() {
                        notify.update({'type': 'success', 'message': '<strong>Term & Condition desactivated successfully.</strong>', 'progress': 75});
                    }, 2000);
                    /** End alert **/
