    ...
    export default {
        ...
        methods: {
            ...
            updateItem() {
                ...
                this.form.put('/dashboard/cookies/' + this.form.id)
                    .then(() => {
                        ...
                        setTimeout(() => this.$router.push({ name: 'cookies.index' }));
                        /** Fin alert **/
                        //End Progress bar
        ...
        created() {
            //Start Progress bar
            this.$Progress.start();
            api.cookieID(this.$route.params.id).then(({data}) => this.form.fill(data.data));
