                                            ...
                                            <tbody>
                                                <tr v-for="item in policyprivacies" :key="item.id">
                                                    ...
                                                    <td class="td-actions text-right">
                                                        ...
                                                        <router-link  :to="{ path: `/dashboard/policy_privacy/lm/${item.title}` }" class="btn btn-link  btn-warning btn-round btn-just-icon" title="View">
                                                            <span class="btn-label">
                                                                <i class="material-icons">visibility</i>
                                                            </span>
                                                        </router-link>
                                                        <router-link :to="{ path: `/dashboard/policy_privacy/${item.id}/edit` }" class="btn btn-link  btn-success btn-round btn-just-icon" title="Edit">
