                    ...
                    <div v-if="loaded" class="row">
                        <div class="col-md-12 expo">
                            <div class="card">
                                ...
                                <br>
                                <div class="card-body">
                                    <div v-if="$auth.can('create-privacy')" class="toolbar">
                                            ...
                                            <tbody>
                                                <tr v-for="item in policyprivacies" :key="item.id">
                                                    ...
                                                    <td class="td-actions text-right">
                                                        <template v-if="$auth.can('publish-privacy')">
                                                        ...
                                                        <router-link  :to="{ path: `/admin/policy_privacy/lm/${item.title}` }" class="btn btn-link  btn-warning btn-round btn-just-icon" title="View">
                                                            <span class="btn-label">
                                                                <i class="material-icons">visibility</i>
                                                            </span>
                                                        </router-link>
                                                        <router-link v-if="$auth.can('edit-privacy')" :to="{ path: `/admin/policy_privacy/${item.id}/edit` }" class="btn btn-link  btn-success btn-round btn-just-icon" title="Edit">
                                                            <i class="material-icons">edit</i>
                                                        </router-link>
                                                        <button v-if="$auth.can('delete-privacy')" @click="deleteItem(item.id)" class="btn btn-link btn-danger btn-round btn-just-icon" title="Delete">
    ...
    export default {
        ...
        methods: {
            ...
            deleteItem(id) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        //Start Progress bar
                        this.$Progress.start();
                        this.form.delete('/admin/policy_privacy/' + id).then(() => {
                            ...
                            setTimeout(function() {
                              notify.update({'type': 'success', 'message': '<strong>Policy & Privacy deleted successfully.</strong>', 'progress': 75});
                            }, 2000);
                            /** End alert ***/
            ...
            activeItem(id) {
                //Start Progress bar
                this.$Progress.start();
                this.form.get('/admin/active_policy_privacy/' + id).then(() => {
                      /** Alert notify bootstrapp **/
                      var notify = $.notify('<strong>Please wait a moment</strong> ...', {
                          allow_dismiss: false,
                          showProgressbar: true
                      ...
                      setTimeout(function() {
                          notify.update({'type': 'success', 'message': '<strong>Policy & Privacy activated successfully.</strong>', 'progress': 75});
                      }, 2000);
                      /** End alert ***/
            ...
            disableItem(id) {
                ...
                this.form.get('/admin/disable_policy_privacy/' + id).then(() => {
                    /** Alert notify bootstrapp **/
                    var notify = $.notify('<strong>Please wait a moment</strong> ...', {
                        allow_dismiss: false,
                        showProgressbar: true
                    ...
                    setTimeout(function() {
                        notify.update({'type': 'success', 'message': '<strong>Policy & Privacy desactivated successfully.</strong>', 'progress': 75});
                    }, 2000);
                    /** End alert ***/
            ...
            loadItems() {
                //Start Progress bar
                this.$Progress.start();
                const url = "/admin/api/policy_privacy";
