        ...
        methods: {
            ...
            activeItem(id) {
                ...
                axios.get('/dashboard/active_occupations/' + id).then(() => {
                    ...
                    setTimeout(function() {
                        notify.update({'type': 'success', 'message': '<strong>Occupations activated successfully.</strong>', 'progress': 75});
                    }, 2000);
                    /** End alert ***/
            ...
            disableItem(id) {
                ...
                axios.get('/dashboard/disable_occupations/' + id).then(() => {
                    ...
                    setTimeout(function() {
                        notify.update({'type': 'success', 'message': '<strong>Occupations desactivated successfully.</strong>', 'progress': 75});
                    }, 2000);
                    /** End alert **/
