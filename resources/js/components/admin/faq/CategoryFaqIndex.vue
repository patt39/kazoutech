                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                            ...
                                            <tr v-for="item in categoryfaqs" :key="item.id">
                                                ...
                                                <td>
                                                    <router-link  v-if="item.user != null" :to="{ path: `/dashboard/profile/${item.user.username}` }">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 v-show="!editmode" class="modal-title" id="addNewLabel"><b>New Category Faq</b></h5>
                                                    <h5 v-show="editmode" class="modal-title" id="updatwNewLabel"><b>Update Category Faq</b></h5>
                                                ...
                                                <div class="modal-body">
                                                    <form id="RegisterValidation" @submit.prevent="editmode ? updateItem() : createItem()" role="form" method="POST" action="" accept-charset="UTF-8" @keydown="form.onKeydown($event)">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="bmd-label-floating"></label>
                                                            <input v-model="form.icon" type="text" name="icon" placeholder="Name icon(materialise icon)" class="form-control" :class="{ 'is-invalid': form.errors.has('icon') }" required/>
                                                            <has-error :form="form" field="icon"></has-error>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="bmd-label-floating"></label>
                                                            <select name="color_name" v-model="form.color_name" id="color_name" class="form-control" :class="{ 'is-invalid': form.errors.has('color_name') }">
        ...
        methods: {
            ...
            updateItem() {
                ...
                this.form.put('/dashboard/category-faqs/' + this.form.id)
                    .then(() => {
                        ...
                        setTimeout(function() {
                            notify.update({'type': 'success', 'message': '<strong>Category Faq updated successfully.</strong>', 'progress': 75});
                        }, 2000);
                        /** Fin alert **/
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        this.form.delete('/dashboard/category-faqs/' + id).then(() => {
                            ...
                            setTimeout(function() {
                                notify.update({'type': 'success', 'message': '<strong>Category Faq deleted successfully.</strong>', 'progress': 75});
                            }, 2000);
                            /*** End alert ***/
            ...
            activeItem(id) {
                ...
                this.form.get('/dashboard/active_category-faqs/' + id).then(() => {
                    ...
                    setTimeout(function() {
                        notify.update({'type': 'success', 'message': '<strong>Category Faq activated successfully.</strong>', 'progress': 75});
                    }, 2000);
            ...
            disableItem(id) {
                ...
                this.form.get('/dashboard/disable_category-faqs/' + id).then(() => {
                    ...
                    setTimeout(function() {
                        notify.update({'type': 'success', 'message': '<strong>Category Faq desactivated successfully.</strong>', 'progress': 75});
                    }, 2000);
                    /** End alert **/
