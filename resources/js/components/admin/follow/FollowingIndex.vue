                        ...
                        <div class="col-md-12 expo">
                            <div class="card card-stats">
                                <div :class="getColorCardUser()">
                                    ...
                                    <p class="card-category">Followings <b v-text="user.name"></b>
                                    <h3 class="card-title" style="color:red;"><b>{{followings.length}}</b></h3>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons">people</i>Followings <b v-text="user.name"></b>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div :class="getColorHeaderUser()">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h4 class="card-title">
                                                Followings <b v-text="user.name"></b>
                                            </h4>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                            ...
                                            <tbody>
                                            <tr v-for="item in followings" :key="item.id">
    ...
    export default {
        ...
        methods: {
            ...
            loadItems(){
                //Start Progress bar
                this.$Progress.start();
                api.followingUsername(this.$route.params.username).then(response => {
                    this.loaded = true;
