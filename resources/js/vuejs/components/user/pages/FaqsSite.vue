                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 mx-auto text-center">
                            <h2 class="display-2 text-white">Frequently Asked Questions(FAQs)</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="cd-section" id="accordion">
              ...
              <div class="section features-1">
                ...
                <div class="row">
                    ...
                    <h3 class="display-3">Toujour pas resolu?</h3>
                    <p class="lead">N'ayez crainte vos doutes et préocupation sont un devoir pour nos.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
