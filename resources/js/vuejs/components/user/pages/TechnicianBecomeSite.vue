 ...
 <div class="about-page">
   <div class="wrapper">
      <div class="page-header page-header-small header-filter">
        <div class="page-header-image" style="background-image: url('/assets/vendor_site/img/pages/georgie.jpg');">
        </div>
        <div class="container">
          <div class="header-body text-center mb-7">
            <div class="row justify-content-center">
              <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                <h1 class="text-white">Dévenez bosseur</h1>
                <p class="text-lead text-white">Arrondissez vos fin de mois en dévenant bosseur et gagnez en notorieté!</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="section">
              <div class="tab-content">
                <div class="tab-pane active" id="link1">
                  <div>
                    <header>
                      <h2 class="text-uppercase">Informatioins Generale</h2>
                    </header>
                    <hr class="line-primary"><br>
                    <div class="row">
                      <div class="col-md-3 align-self-center">
                        <label class="labels" for="#firstName">Nom<span style="color: red">*</span></label>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-3 align-self-center">
                        <label class="labels">Prénom<span style="color: red">*</span></label>
                      </div>
                      <div class="col-md-9 align-self-center">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-3 align-self-center">
                        <label class="labels">Sex<span style="color: red">*</span></label>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-3 align-self-center">
                        <label class="labels">Date de naiscançe<span style="color: red">*</span></label>
                      </div>
                      <div class="col-md-9 align-self-center">
                        <div class="row">
                          <div class="col-md-4 align-self-center">
                    ...
                    <div class="row">
                      <div class="col-md-3 align-self-center">
                        <label class="labels" for="#email">Email<span style="color: red">*</span></label>
                      </div>
                      <div class="col-md-9 align-self-center">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-3 align-self-center">
                        <label class="labels" for="#confirmEmail">Confirmer Email<span style="color: red">*</span></label>
                      </div>
                      <div class="col-md-9 align-self-center">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-3 align-self-center">
                        <label class="labels" for="#location">ville<span style="color: red">*</span></label>
                      </div>
                      <div class="col-md-9 align-self-center">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-3 align-self-center">
                        <label class="labels" for="#phone">Numéro de téléfone<span style="color: red">*</span></label>
                      </div>
                      <div class="col-md-4 align-self-center">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-3 align-self-center">
                        <label class="labels">Languague<span style="color: red">*</span></label>
                      </div>
                      <div class="col-md-4 align-self-center">
                        <div class="form-group">
                          <select class="form-control" data-trigger name="choices-single-default" id="choices-single-default">
                    ...
                    <div class="row">
                      <div class="col-md-3 align-self-center">
                        <label class="labels">Aptitudes</label>
                      </div>
                      <div class="col-md-9 align-self-center">
...
<script>
    ...
    export default {
        ...
        data() {
            ...
            let composantTitle = 'TechnicianBecome page';
