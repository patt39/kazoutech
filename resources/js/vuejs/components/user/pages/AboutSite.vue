            ...
            <div class="col-lg-4 mr-auto text-left mt-4">
              <div class="card bg-default shadow border-0">
                ...
                <blockquote class="card-blockquote">
                  ...
                  <h4 class="display-4 text-white">Technologies pour tous</h4>
                  <p class="lead text-italic text-white">Les nouvelles technologies pour et a la porter de tous pour amegliorer les relation humaines et le service entre voisin.</p>
                </blockquote>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="info info-hover-warning">
                    ...
                    <h5 class="info-title">Meilleur des services</h5>
                    <p class="description opacity-8">Sur notre plateforme nous travaillons avec des personne honnete et digne de confiance qui saurons vous apporter les meilleur des services qui sois dans de bréf délais.</p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="info info-hover-info">
                    ...
                    <h5 class="info-title">Pèspectifs de travail</h5>
                    <p class="description opacity-8">Nous nous assurons du bon déroulement de votre tache tout en réspectant les consigne de securité et le droit du travail.</p>
                  </div>
                </div>
              </div>
              <div class="row mt-lg-4">
                <div class="col-md-6">
                  <div class="info info-hover-danger">
                    ...
                    <h5 class="info-title">Transparence</h5>
                    <p class="description opacity-8">La transparence et la reconnaisançe sont de valeurs que nous mettons a avant et cherchons a amegliorer sans cèsse pour un avenir meilleur.</p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="info info-hover-success">
                    ...
                    <h5 class="info-title">Révenue garantit</h5>
                    <p class="description opacity-8">En fin mais pas de moindre nous voulons apporter une assurance de revenue pour arrondir les fin de mois difficile tout en conservant votre statut d'auto-entrepreneur.</p>
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <div class="card card-blog card-background card-grande" data-animation="zooming">
                        ...
                        <a href="javascript:;">
                         <div class="card-body mb-4">
                            ...
                            <p class="card-description text-white">Une simple illustration de comment nous travaillons pour toujours vous apporter le meilleur de nos service</p>
                            <br>
                            </div>
                        </a>
                        </div>
