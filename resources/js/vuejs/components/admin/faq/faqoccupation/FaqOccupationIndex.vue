                        ...
                        <div class="col-md-12 expo">
                            <div class="card card-stats">
                                <div :class="getColorCardUser()">
                                    ...
                                    <p class="card-category"><b>All FAQsOccupation</b>
                                    <h3 class="card-title" style="color:red;"><b>{{faqoccupations.length}}</b></h3>
                                </div>
                            ...
                            <div class="card">
                                <div :class="getColorHeaderUser()">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h4 class="card-title">
                                                <b>Datatables FaqsOccupations</b>
                                            </h4>
                                            <p class="card-title">
                                                FaqsUccupations Available
                                            </p>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="toolbar">
                                            <div class="submit text-center">
                                                ...
                                                <router-link :to="{ name: 'faqs.dashboard_sites' }" id="button_hover" class="btn btn-info btn-raised">
                                                    ...
                                                    <b class="title_hover">FAQsOccupation Site</b>
                                                </router-link>
                                            </div>
                                        </div>
                                        <div class="material-datatables">
                                            <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                                ...
                                                <tbody>
                                                <tr v-for="item in faqoccupations" :key="item.id">
                                                    <td>{{ (faqs.faqoccupations.title.length > 15 ? item.title.substring(0,15)+ "..." : item.title) | upText }}</td>
                                                    <td>
                                                        <b> <router-link  :to="{ path: `/dashboard/faqs/c/${item.categoryfaq.slug}/` }">
                                                        <b>{{ (faqs.faqoccupations.occupation.name.length > 15 ? faqs.faqoccupations.occupation.name.substring(0,15)+ "..." : faqs.faqoccupations.occupation.name) | upText }}</b>
                                                        </router-link></b>
                                                    </td>
                                                    <td>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="addNewLabel">
                                                            <span :class="colorBage()"><b v-text="faq.faqoccupations.name"></b></span>
                                                        </h5>
                                                                ...
                                                                <div class="card-header" role="tab" id="headingOne">
                                                                    <h5 class="mb-0">
                                                                        <a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                                           {{faq.faqoccupations.title}}
                                                                            <i class="material-icons">keyboard_arrow_down</i>
                                                                        </a>
                                                                    </h5>
                                                                </div>
                                                                <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                                                    <div class="card-body" v-html="faq.faqoccupations.body"></div>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadItems() {
                //Start Progress bar
                this.$Progress.start();
                dyaxios.get("occupations.view").then(response => {
                    this.loaded = true;
                    this.occupationfaqs = response.data;
                    this.mydatatables();
                });
