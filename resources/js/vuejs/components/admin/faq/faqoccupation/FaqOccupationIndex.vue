              ...
              <div class="card card-stats">
                <div :class="getColorCardUser()">
                  ...
                  <p class="card-category">
                    <b>All FAQsOccupation</b>
                  </p>
                  <h3 class="card-title" style="color:red;">
                    <b>{{faqoccupations.length}}</b>
                  </h3>
                </div>
                ...
                <div :class="getColorHeaderUser()">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <p class="card-title">FaqsUccupations Available</p>
                    </div>
                        ...
                        <tbody>
                          <tr v-for="item in faqoccupations" :key="item.id">
                            ...
                            <td>
                              <b>
                                <router-link
                                  :to="{ path: `/dashboard/faqs_occupation/c/${item.occupation.slug}/` }"
                                >
...
export default {
  ...
  methods: {
    ...
    loadItems() {
      //Start Progress bar
      this.$Progress.start();
      let url = route("api.faqoccupation");
      dyaxios.get(url).then(response => {
        this.loaded = true;
        this.faqoccupations = response.data;
        this.mydatatables();
      });
