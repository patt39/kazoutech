                ...
                <div :class="getColorHeaderUser()">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <p class="card-title">Profile Users</p>
                    </div>
                    ...
                    <div v-for="(item,index) in users" :key="index" class="col-md-4 col-sm-4">
                      <div class="card card-profile">
                        ...
                        <div class="stats text-center">
                          <button
                            @click="viewItem(item)"
                            class="btn btn-warning btn-just-icon btn-fill btn-round btn-sm"
                          >
                          ...
                          <router-link
                            ...
                            class="btn btn-success btn-just-icon btn-fill btn-sm btn-round btn-wd"
                            title="Edit"
                          >
                        ...
                        <div class="card-body">
                          <h6 v-if="item.statusOnline">
                            <span class="badge badge-success" title="User online">Online</span>
                          </h6>
                          <h6 v-else="item.statusOnline">
                            <span class="badge badge-danger" title="user offline">Offline</span>
                          </h6>
                          <h4 class="card-title">
                            <b>{{ item.name }} {{ item.first_name }}</b>
                          </h4>
                          <h4 class="card-title">
                            <b>Sex:</b>
                            {{ item.sex }}
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-6 ml-auto mr-auto">
                      <div class="profile text-center" style="padding-top: -100px;">
                        <div class="avatar">
                          <div
                          ...
                          >
                            <div class="fileinput-new thumbnail img-circle img-raised">
                              <img :alt="userProfile.name" :src="userProfile.avatar" />
                            </div>
                            <div
                              class="fileinput-preview fileinput-exists thumbnail img-circle img-raised"
                            ></div>
                          </div>
                        </div>
                      </div>
