                        ...
                        <div class="col-md-12 expo">
                            <div class="card card-stats">
                                <div :class="getColorCardUser()">
                                    ...
                                    <p class="card-category">All Technicians</p>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="toolbar">
                                        <div class="submit text-center">
                                            <router-link :to="{ name: 'technicians.index' }" id="button_hover" class="btn btn-success btn-raised btn-round ">
                                               <span class="btn-label">
                                                   <i class="material-icons">perm_identity</i>
                                               </span>
                                                <b class="title_hover">ALL TECHNICIAN</b>
                                            </router-link>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Modal view Technician by occupation -->
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            loadItems() {
                this.$Progress.start();
                api.technicianOccupation(this.$route.params.occupation).then(response => {
                    this.loaded = true;
