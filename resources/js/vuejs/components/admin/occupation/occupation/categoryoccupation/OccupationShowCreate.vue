                                            ...
                                            <form id="RegisterValidation" @submit.prevent="createItem()" role="form"
                                                ...
                                                <div class="submit">
                                                    <div class="text-center">
                                                        <router-link id="button_hover" :to="{ name: 'occupations.show_dashboard', params: { occupation: occupation.slug  } }" class="btn btn-danger" data-toggle="tab">
    ...
    export default {
        ...
        methods: {
            ...
            createItem() {
                ...
                let url = route('occupations.show_dashboard_store',this.occupation.slug);
                this.form.post(url)
                    .then(() => {
                        /** Debut de l'alert **/
        ...
        mounted() {
            //Start Progress bar
            this.$Progress.start();
            let url = route('occupations.apioccupationbyslug',this.$route.params.occupation);
            dyaxios.get(url).then(response => {this.occupation = response.data});
