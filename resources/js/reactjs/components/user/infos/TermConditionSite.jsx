                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-10 mx-auto text-center">
                                    <h2 className="display-2 text-white">Condition D'utilisation</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="card card-profile" data-image="img-rounded">
                                    <div className="row justify-content-center pt-100 pb-5">
                                        <div className="col-lg-11">
                                            <h3 className="display-3">{condition.title}</h3>
                                            <div className="description mb-2" dangerouslySetInnerHTML={{ __html: condition.body }} />
                                                </div>
                                            </div>
                                    </div>
                                </div>
