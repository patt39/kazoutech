...
class ProfileUserSiteEdit extends Component {
    ...
    saveProfile(e) {
        e.preventDefault();
        let usernameProfile = this.props.match.params.username;
        let updateProfile = {
        ...
        dyaxios.put(route('devenir_charbonneur.update', usernameProfile), updateProfile)
            .then(() => {
    ...
    render() {
        ...
        document.title = `${this.state.name} | Edition Profil`;
        return (
